...
//   {
//     id: 1,
//     name: 'Men Formal Office Wear T Shirt',
//     price: 599,
//     img: 'https://ik.imagekit.io/zifllo6u3/download%20(11).jpeg?updatedAt=1745587799651',
//     description: 'Premium cotton Short sleeve T-shirt .',
//   },
//   {
//     id: 2,
//     name: 'Men White Textured Polo Neck T-shirt',
//     price: 1199,
//     img: 'https://ik.imagekit.io/zifllo6u3/download%20(10).jpeg?updatedAt=1745587799381',
//     description: '! ',
//   },
//   {
//     id: 3,
//     name: 'Regular Fit Formal T-Shirt',
//     price: 499,
//     img: 'https://ik.imagekit.io/zifllo6u3/download%20(9).jpeg?updatedAt=1745587799520',
//     description: 'Swing into style with this t-shirt.',
//   },
//   {
//     id: 4,
//     name: 'T-Store Mens Beige Button Down Collar Cotton Solid Polo T-Shirt for Men & Boys | Half Sleeve | Formal T-Shirt | Office T-Shirt',
//     price: 499,
//     img: 'https://ik.imagekit.io/zifllo6u3/download%20(8).jpeg?updatedAt=1745587799371',
//     description: 'Swing into style with this t-shirt.',
//   },
//   {
//     id: 5,
...
function Formal() {
  ...
  useEffect(() => {
    const fetchFormalTshirts = async () => {
      try {
        ...
        console.error('Error fetching formal t-shirts:', err);
      }
    };
  ...
  return (
    <div className="bg-gray-900 text-white pt-4 px-4 min-h-screen">
      <h2 className="text-2xl font-bold mb-6">Formal T-Shirts</h2>
      {isLoading ? (
