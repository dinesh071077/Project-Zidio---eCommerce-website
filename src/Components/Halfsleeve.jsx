...
//   {
//     id: 1,
//     name: 'Fierce Name Customized Printed Mens Half Sleeves Cotton T-Shirt',
//     price: 299,
//     img: 'https://ik.imagekit.io/zifllo6u3/images%20(3).jpeg?updatedAt=1745399991213',
//     description: 'Premium cotton Fullsleeve  T-shirt  .',
//   },
//   {
//     id: 2,
//     name: 'Men Oversized Heavyweight Half Sleeve T-shirt ',
//     price: 349,
//     img: 'https://ik.imagekit.io/zifllo6u3/images%20(2).jpeg?updatedAt=1745399991221',
//     description: '! ',
//   },
//   {
//     id: 3,
//     name: 'Black 4 Way Lycra Plain Mens Half Sleeve Gym T-Shirt',
//     price: 299,
//     img: 'https://ik.imagekit.io/zifllo6u3/images%20(4).jpeg?updatedAt=1745399991213',
//     description: 'Swing into style with this t-shirt.',
//   },
//   {
//     id: 4,
//     name: 'Men Full Sleeve Mandarin Collar T-Shirt | Maroon',
//     price: 399,
//     img: 'https://ik.imagekit.io/zifllo6u3/full1.jpeg?updatedAt=1745336371606',
//     description: 'Swing into style with this t-shirt.',
//   },
// ];
...
function Halfsleeve() {
  ...
  useEffect(() => {
    const fetchTshirts = async () => {
      try {
        const res = await fetch('http://localhost:5000/api/tshirt/type/Half Sleeve');
        const data = await res.json();
        setTshirts(data);
        setIsLoading(false);
      } catch (err) {
        console.error('Error fetching half sleeve t-shirts:', err);
      }
    };
  ...
  return (
    <div className="bg-gray-900 text-white pt-4 px-4 min-h-screen">
      <h2 className="text-2xl font-bold mb-6">Half Sleeve T-Shirts</h2>
      {isLoading ? (
