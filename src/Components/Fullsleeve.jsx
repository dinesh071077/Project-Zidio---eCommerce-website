...
//   {
//     id: 1,
//     name: 'Cork Plain Full Sleeves Regular Fit T-shirt',
//     price: 549,
//     img: 'https://ik.imagekit.io/zifllo6u3/full.jpeg?updatedAt=1745336371612',
//     description: 'Premium cotton Fulls leeve  T-shirt  .',
//   },
//   {
//     id: 2,
//     name: 'Men Purple OverSized Full Sleeve T-Shirt ',
//     price: 659,
//     img: 'https://ik.imagekit.io/zifllo6u3/full3.jpeg?updatedAt=1745336371495',
//     description: '! ',
//   },
//   {
//     id: 3,
//     name: 'Navy Blue Plain Full Sleeves Regular Fit T-shirt',
//     price: 499,
//     img: 'https://ik.imagekit.io/zifllo6u3/full2.jpeg?updatedAt=1745336371500',
...
function Fullsleeve() {
  ...
  useEffect(() => {
    const fetchTshirts = async () => {
      try {
        ...
        console.error('Error fetching full sleeve t-shirts:', err);
      }
    };
  ...
  return (
    <div className="bg-gray-900 text-white pt-4 px-4 min-h-screen">
      <h2 className="text-2xl font-bold mb-6">Full Sleeve T-Shirts</h2>
      {isLoading ? (
