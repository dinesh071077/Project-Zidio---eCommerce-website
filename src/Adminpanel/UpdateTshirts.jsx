...
//   useEffect(() => {
//     fetch('/api/tshirts') // Update to your backend API
//       .then(res => res.json())
...
//   const handleEdit = (id) => {
//     navigate(`/edit-tshirt/${id}`); // Navigate to edit page
//   };
...
//                 <td className="py-2">
//                   <img src={tshirt.image} alt={tshirt.name} className="w-12 h-12 object-cover rounded" />
//                 </td>
//                 <td className="py-2">{tshirt.name}</td>
//                 <td className="py-2">₹{tshirt.price}</td>
//                 <td className="py-2">{tshirt.type}</td>
//                 <td className="py-2">
//                   <button
...
//             {tshirts.length === 0 && (
//               <tr>
//                 <td colSpan="5" className="text-center py-4 text-gray-400">No T-shirts found</td>
//               </tr>
//             )}
//           </tbody>
//         </table>
...
const UpdateTshirts = () => {
  ...
  const fetchTshirts = async () => {
    try {
      const res = await fetch('http://localhost:5000/api/put/all');
